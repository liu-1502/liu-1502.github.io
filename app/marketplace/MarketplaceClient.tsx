...
export default function MarketplaceClient() {
  useEffect(() => {
    ...
    /* swap circle: đảo chiều (deposit <-> withdraw) bằng cách bấm nút dir chưa active */
    ...
    /* ===== Logic deposit/withdraw: format + mirror + USD + % + rate line ===== */
    ...
    document.querySelectorAll<HTMLElement>("[data-dirpanel]").forEach(function (panel) {
      ...
      const update = function () {
        ...
        if (cta) cta.disabled = false;   /* ko disable theo số nhập */
      };
