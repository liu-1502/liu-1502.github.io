    ...
    <div className="pg-whitelist">
      ...
      <svg className="wl-illus" viewBox="0 0 480 480" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <g clipPath="url(#wlIllusClip)">
          ...
          <path d="M46.59 342.278C51.9459 343.366 57.17 339.907 58.2582 334.551C59.3464 329.195 55.8867 323.971 50.5308 322.882C45.1749 321.794 39.9508 325.254 38.8626 330.61C37.7744 335.966 41.2341 341.19 46.59 342.278Z" fill="#7ABA16" />
          <path d="M141.15 97.3108C145.613 98.2177 149.966 95.3346 150.873 90.8713C151.78 86.408 148.897 82.0547 144.434 81.1478C139.97 80.241 135.617 83.1241 134.71 87.5873C133.803 92.0506 136.686 96.404 141.15 97.3108Z" fill="#7ABA16" />
          <path d="M356.211 133.307C360.674 134.214 365.027 131.331 365.934 126.868C366.841 122.405 363.958 118.051 359.495 117.144C355.031 116.238 350.678 119.121 349.771 123.584C348.864 128.047 351.747 132.401 356.211 133.307Z" fill="#7ABA16" />
          ...
          <path d="M277.539 205.947C282.002 206.854 286.355 203.971 287.262 199.508C288.169 195.044 285.286 190.691 280.823 189.784C276.359 188.877 272.006 191.76 271.099 196.224C270.192 200.687 273.075 205.04 277.539 205.947Z" fill="#7ABA16" />
        </g>
        <defs>
