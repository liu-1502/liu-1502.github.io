    ...
    <div className="pg-whitelist">
      ...
      <svg className="wl-illus" viewBox="0 0 480 480" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <g clipPath="url(#wlIllusClip)">
          ...
          <path d="M375.839 336.873C367.838 335.248 362.622 327.372 364.248 319.371C365.873 311.37 373.749 306.154 381.75 307.78C389.75 309.405 394.966 317.281 393.341 325.282C391.715 333.283 383.839 338.499 375.839 336.873ZM380.765 312.629C375.431 311.545 370.18 315.022 369.096 320.356C368.013 325.69 371.49 330.941 376.824 332.024C382.158 333.108 387.408 329.631 388.492 324.297C389.576 318.963 386.098 313.712 380.765 312.629Z" fill="currentColor" />
          <path d="M46.59 342.278C51.9459 343.366 57.17 339.907 58.2582 334.551C59.3464 329.195 55.8867 323.971 50.5308 322.882C45.1749 321.794 39.9508 325.254 38.8626 330.61C37.7744 335.966 41.2341 341.19 46.59 342.278Z" fill="currentColor" />
          <path d="M141.15 97.3108C145.613 98.2177 149.966 95.3346 150.873 90.8713C151.78 86.408 148.897 82.0547 144.434 81.1478C139.97 80.241 135.617 83.1241 134.71 87.5873C133.803 92.0506 136.686 96.404 141.15 97.3108Z" fill="currentColor" />
          <path d="M356.211 133.307C360.674 134.214 365.027 131.331 365.934 126.868C366.841 122.405 363.958 118.051 359.495 117.144C355.031 116.238 350.678 119.121 349.771 123.584C348.864 128.047 351.747 132.401 356.211 133.307Z" fill="currentColor" />
          <path d="M156.405 189.785C160.868 190.692 165.222 187.808 166.128 183.345C167.035 178.882 164.152 174.529 159.689 173.622C155.226 172.715 150.872 175.598 149.965 180.061C149.059 184.524 151.942 188.878 156.405 189.785Z" fill="currentColor" />
          <path d="M277.539 205.947C282.002 206.854 286.355 203.971 287.262 199.508C288.169 195.044 285.286 190.691 280.823 189.784C276.359 188.877 272.006 191.76 271.099 196.224C270.192 200.687 273.075 205.04 277.539 205.947Z" fill="currentColor" />
        </g>
        <defs>
